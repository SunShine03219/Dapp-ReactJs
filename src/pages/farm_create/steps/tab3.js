...
export const Tab3 = (props) => {
    ...
    const handleNextButton = async () => {
        ...
        try {
            ...
            const maxTokenDecimal = new BN((10 ** lpToken.decimals).toString(), 10);
            ...
            if (typeof endDate === "undefined") {
                ...
                deploymentRes = await deployerContract.deployERC20Farm(walletAddress, lpToken.address, rewardToken.address, startBlock, rewardPerBlock.toString(), maxTokenAmountWithDecimal.toString(), minimumLockTime * 20 * 60 * 24, emergencyWithdrawFee * 100, feeReceiver == "" ? NULL_ADDRESS : feeReceiver, false, cost)
            } else {
                ...
                poolType = 2;
                console.log(walletAddress);
                deploymentRes = await deployerContract.deployERC20FarmFixEnd(walletAddress, lpToken.address, rewardToken.address, startBlock, parseInt(endBlock), maxTokenAmountWithDecimal.toString(), minimumLockTime * 20 * 60 * 24, emergencyWithdrawFee * 100, feeReceiver == "" ? NULL_ADDRESS : feeReceiver, cost)
            }
    ...
    return (
        <>
            <div className="row">
                ...
                <div className="col-6 col-sm-12 col-xl-6 text-center-mt-6">
                    <p className="paragraph-with-bg align-right"><strong>LP token pool</strong>
                        <br /><br />
                        <img src={mainToken0.logoURI} width="20px" />
                        <img src={mainToken1.logoURI} width="20px" style={{ marginLeft: "-10px" }} />
                        <strong>{mainToken0.symbol} / {mainToken1.symbol}</strong>
                        <br /><br />
                ...
                <div className="col-6 col-sm-12 col-xl-6 text-center-mt-6">
                    <p className="paragraph-with-bg align-left"><strong>Reward</strong><br /><svg xmlns="http://www.w3.org/2000/svg" viewBox="-64 0 512 512" width="1em" height="1em" fill="currentColor" style={{ fontSize: "11px" }}>
                ...
                <div className="col-xl-6 button-section">
                    <button className="btn btn-primary next-button ml-0" data-bss-hover-animate="pulse" type="button" onClick={handleNextButton}>Next</button></div>
                <div className="col-xl-6 button-section">
