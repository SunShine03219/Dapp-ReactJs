            ...
            <div className="row">
                ...
                <div className="col-12 col-sm-12 col-xl-12 text-center-mt-6">
                    ...
                    <p className="paragraph-with-bg align-left round-17-bg-mt-5"><strong>&nbsp; &nbsp; &nbsp; </strong><br /><
                        ...
                        <img src={mainToken0.logoURI} style={{ width: "14px", marginLeft: "14px" }} /> <img src={mainToken1.logoURI} style={{ width: "14px", marginLeft: "-7px" }} />&nbsp; {mainToken0.symbol} / {mainToken1.symbol}<br />
