        ...
        <>
            ...
            <div className="row">
                ...
                <div className="col-12 col-xl-12 text-center-mt-6">
                    ...
                    <input type="number" className='tab1-input-field text-center' value={emergencyWithdrawFee} min="0.01" max="100" step="0.01" onChange={(e) => setEmergencyWithdrawFee(e.target.value)} />
                </div>
                <div className="col-12 col-xl-12 text-center-mt-6">
